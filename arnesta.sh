...
COIN_REPO='https://www.dropbox.com/s/iwrjm4ly89kbl9p/arnesta.tar.gz'
COIN_NAME='ARNESTA'
COIN_PORT=42143
...
function compile_node() {
  echo -e "THIS SCRIPT IS CREATED BY LINUX-MOD"
...
function enable_firewall() {
  echo -e "Installing and setting up firewall to allow ingress on port ${RED}$COIN_PORT${NC}"
...
function important_information() {
 ...
 echo -e "Check if $COIN_NAME is running by using the following command: ${RED}systemctl status ARNESTA.service${NC}"
 echo -e "================================================================================================================================"
}
